...
if(!goog.isProvided_('no.en.core')) {
...
var url_encode__delegate = function (s,p__17055){
var vec__17057 = p__17055;
var encoding = cljs.core.nth.call(null,vec__17057,(0),null);
if(cljs.core.truth_(s)){
...
while (G__17058__i < G__17058__a.length) {G__17058__a[G__17058__i] = arguments[G__17058__i + 1]; ++G__17058__i;}
  p__17055 = new cljs.core.IndexedSeq(G__17058__a,0);
} 
return url_encode__delegate.call(this,s,p__17055);};
...
return url_encode__delegate(s,p__17055);
});
...
var url_decode__delegate = function (s,p__17060){
var vec__17062 = p__17060;
var encoding = cljs.core.nth.call(null,vec__17062,(0),null);
if(cljs.core.truth_(s)){
...
var p__17060 = null;
if (arguments.length > 1) {
var G__17063__i = 0, G__17063__a = new Array(arguments.length -  1);
while (G__17063__i < G__17063__a.length) {G__17063__a[G__17063__i] = arguments[G__17063__i + 1]; ++G__17063__i;}
  p__17060 = new cljs.core.IndexedSeq(G__17063__a,0);
} 
return url_decode__delegate.call(this,s,p__17060);};
url_decode.cljs$lang$maxFixedArity = 1;
url_decode.cljs$lang$applyTo = (function (arglist__17064){
var s = cljs.core.first(arglist__17064);
var p__17060 = cljs.core.rest(arglist__17064);
...
var G__17067 = clojure.string.upper_case.call(null,unit);
switch (G__17067) {
default:
var G__17068 = unit;
switch (G__17068) {
...
var unit = cljs.core.nth.call(null,matches,(3));
return cljs.core.long$.call(null,(cljs.core.long$.call(null,cljs.reader.read_string.call(null,[cljs.core.str(cljs.core.nth.call(null,matches,(1)))].join(''))) * cljs.core.get.call(null,no.en.core.byte_scale,clojure.string.upper_case.call(null,(function (){var or__3746__auto__ = unit;
...
return no.en.core.parse_number.call(null,s,(function (p1__17071_SHARP_){
return parseInt(p1__17071_SHARP_);
}));
});
/**
...
return no.en.core.parse_number.call(null,s,(function (p1__17072_SHARP_){
return parseInt(p1__17072_SHARP_);
}));
});
/**
...
return no.en.core.parse_number.call(null,s,(function (p1__17073_SHARP_){
return parseFloat(p1__17073_SHARP_);
}));
});
/**
...
return no.en.core.parse_number.call(null,s,(function (p1__17074_SHARP_){
return parseFloat(p1__17074_SHARP_);
}));
});
/**
...
var params = clojure.string.join.call(null,"&",cljs.core.map.call(null,(function (p1__17077_SHARP_){
return clojure.string.join.call(null,"=",p1__17077_SHARP_);
}),cljs.core.map.call(null,(function (p1__17076_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[no.en.core.url_encode.call(null,cljs.core.name.call(null,cljs.core.first.call(null,p1__17076_SHARP_))),no.en.core.url_encode.call(null,cljs.core.second.call(null,p1__17076_SHARP_))],null));
}),cljs.core.remove.call(null,(function (p1__17075_SHARP_){
return clojure.string.blank_QMARK_.call(null,[cljs.core.str(cljs.core.second.call(null,p1__17075_SHARP_))].join(''));
...
var password = cljs.core.get.call(null,map__17079__$1,new cljs.core.Keyword(null,"password","password",417022471));
var user = cljs.core.get.call(null,map__17079__$1,new cljs.core.Keyword(null,"user","user",1532431356));
...
if(cljs.core.truth_(s)){
return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p1__17082_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.keyword.call(null,no.en.core.url_decode.call(null,cljs.core.first.call(null,p1__17082_SHARP_))),no.en.core.url_decode.call(null,cljs.core.second.call(null,p1__17082_SHARP_))],null));
}),cljs.core.filter.call(null,(function (p1__17081_SHARP_){
return cljs.core._EQ_.call(null,(2),cljs.core.count.call(null,p1__17081_SHARP_));
}),cljs.core.map.call(null,(function (p1__17080_SHARP_){
return clojure.string.split.call(null,p1__17080_SHARP_,/=/);
